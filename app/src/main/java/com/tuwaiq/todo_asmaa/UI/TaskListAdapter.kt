...
class TaskListAdapter(private var tasks: List<Task>, val viewModel: MainViewModel) :
    RecyclerView.Adapter<CustomAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomAdapter.ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.task_item_fragment, parent, false)
    ...
    override fun onBindViewHolder(holder: CustomAdapter.ViewHolder, position: Int) {
        ...
        if (!compDueToNow) {
            ...
            val newcolor = holder.itemView.resources.getColor(R.color.outdated)
        ...
        holder.deleteTask.setOnClickListener {
            val alert = AlertDialog.Builder(holder.itemView.context, R.style.dialogStyle)
